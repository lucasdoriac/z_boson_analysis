...
void MakeTProfile_PbPb(TFile* inputFile, double lowCent, double highCent){
    ...
    TDirectory* dir = inputFile->GetDirectory("PbPb2023_2024_Data");
    ...
    */
    ...
    h2D_PtMuPl_PtMuMi->GetZaxis()->SetTitle("N of dimuons");
    ...
    //TProfile formatting
    h_PbPb_TProfile->SetLineColor(kRed + 1);
    h_PbPb_TProfile->SetMarkerColor(kRed + 1);
    h_PbPb_TProfile->SetMarkerStyle(20);
    h_PbPb_TProfile->SetMarkerSize(0.8);
    h_PbPb_TProfile->SetLineWidth(2);

    //Range
    h2D_PtMuPl_PtMuMi->GetXaxis()->SetRangeUser(18., 100.);
    h2D_PtMuPl_PtMuMi->GetYaxis()->SetRangeUser(18., 100.);
    h_PbPb_TProfile->GetXaxis()->SetRangeUser(18., 100.);
    h_PbPb_TProfile->GetYaxis()->SetRangeUser(18., 100.);
    ...
    TLine* diagonal = new TLine(
        h2D_PtMuPl_PtMuMi->GetXaxis()->GetXmin(),
        h2D_PtMuPl_PtMuMi->GetXaxis()->GetXmin(),
        h2D_PtMuPl_PtMuMi->GetXaxis()->GetXmax(),
        h2D_PtMuPl_PtMuMi->GetXaxis()->GetXmax());
